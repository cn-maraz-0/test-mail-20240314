 ...
 * @version $Id: editprofile_functions.php,v 1.4.2.1 2005/04/21 11:37:34 avel Exp $
	...
	*/
		...
		foreach($editprofile_langs as $l) {
			...
			if(sizeof($editprofile_langs) > 1) {
				 ...
				 * indicator. */
				echo '<img src="images/flags/'.$l.'flag.gif" alt="['.$l.']" /> ';
			}
			echo '<input type="text" size="25" name="myprofile['.$a.']" value="';
			if(isset($entry[0][$a])) {
