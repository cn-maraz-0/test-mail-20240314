...
foreach($users as $username) {
    ...
    for($i=0; $i<sizeof($rules); $i++) {
        if($rules[$i]['type'] == '11') {
            ...
            uoa_migrate_prerelease_spamrule_to_junkmail($rules[$i], $username);
 ...
 * </pre>
 */
function uoa_migrate_prerelease_spamrule_to_junkmail(&$rule, $username) {
