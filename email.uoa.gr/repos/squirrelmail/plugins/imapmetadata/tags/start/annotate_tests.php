 ...
 *
 * Test script that showcases features of ANNOTATEMORE.
 *
 ...
 * @version $Id: annotate_tests.php,v 1.1.1.1 2006/02/08 11:22:36 avel Exp $
 * @package plugins
...
require_once(SM_PATH . 'plugins/annotatemore/imap_annotate.php');
...
sqgetGlobalVar('annotatemoretest', $annotatemoretest, SQ_GET);
...
<a href="annotate_tests.php?annotatemoretest=showall_internal">
Show Annotations (Internal Flat Structure)
</a>
|
<a href="annotate_tests.php?annotatemoretest=showall_internal_tree">
Show All Annotations (Internal Entry Tree Structure)
</a>
|
<a href="annotate_tests.php?annotatemoretest=showall">
Show All Annotations (Flat Pretty Print)
</a>
|
<a href="annotate_tests.php?annotatemoretest=showall_tree">
Show All Annotations (Entry Tree Pretty Print)
</a>
|
<a href="annotate_tests.php?annotatemoretest=set">
Set an Annotation
</a>
';


if(strstr($annotatemoretest, 'tree')) {
   $tree = true;
} else {
   $tree = false;
}

switch($annotatemoretest) {
    ...
    case 'delete':
        ...
        echo '<form action="annotate_tests.php?annotatemoretest=set" method="POST">

        Mailbox: '.annotatemore_mailboxlist('mailbox', $mailbox) .'
        <br/>
 ...
 * @return string
 */
function annotatemore_mailboxlist($selectname, $selectedmbox, $sub = false) {
