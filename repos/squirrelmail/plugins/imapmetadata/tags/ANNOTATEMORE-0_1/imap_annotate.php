<?php
/**
 * Implementation of ANNOTATEMORE, useful for setting / getting metadata in
 * IMAP server.
 *
 * Licensed under the GNU GPL. For full terms see the file COPYING that came
 * with the Squirrelmail distribution.
 *
 * @version $Id: imap_annotate.php,v 1.1.1.1 2006/02/08 11:22:36 avel Exp $
 * @author Alexandros Vellis <avel+devel@noc.uoa.gr>
 * @copyright 2005-2006 Alexandros Vellis
